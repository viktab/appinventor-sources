...
public interface OdeMessages extends Messages, AutogeneratedOdeMessages {
  ...
  @DefaultMessage("Import API")
  @Description("String shown in the palette to import an API")
  String importAPIMenuItem();
  ...
  @DefaultMessage("Import an API into project")
  @Description("Caption for API import wizard")
  String apiImportWizardCaption();
  ...
  @DefaultMessage("Import API Failed!")
  @Description("Error message reported when the API import failed")
  String apiImportError();
