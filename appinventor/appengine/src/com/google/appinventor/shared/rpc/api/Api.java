...
/**
 * API stored in the server
 */
public class Api implements IsSerializable {
  private long id;
  ...
  public Api(long id, String authorId, String fullyQualifiedName, long version) {
  ...
  public static Api valueOf(String text) {
    ...
    return new Api(id, authorId, fullyQualifiedName, version);
  }
